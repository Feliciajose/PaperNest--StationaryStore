...
### 🧭 Page Navigation
- **Home Page**
  - Clicking any product navigates to the **Product Listing Page**
- **Product Listing Page**
  - Clicking any product navigates to the **Product Detail Page**
- **Product Detail Page**
...
- **Filter Options**
  - Category (Pen, Pencil, Notebook, Journal)
  - Product Type (Single / Multi)
